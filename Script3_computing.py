...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, nargs='?', default='mineral_indices', help='Computing method in ODPS, [mosaic,color_balancing,mineral_indices].')
    ...
    elif method == 'color_balancing': # dn2radiance, atmospheric correction, merge, color(spectral) transfer
