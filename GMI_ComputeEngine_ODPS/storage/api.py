...
from GMI_ComputeEngine_ODPS.storage import data_types
from GMI_ComputeEngine_ODPS.storage.client import StorageClient
...
class Storage():
    ...
    def __client(cls) -> StorageClient:
        if getattr(cls, '__CLIENT', None) is None:
            cls.__CLIENT = StorageClient(base_url=GMI_ComputeEngine_ODPS.api_baseurl, api_key=GMI_ComputeEngine_ODPS.api_key)
        return cls.__CLIENT
