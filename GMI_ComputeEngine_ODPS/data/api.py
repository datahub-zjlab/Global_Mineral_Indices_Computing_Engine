...
from GMI_ComputeEngine_ODPS.data.client import DataClient
...
class Data():
    ...
    def __client(cls) -> DataClient:
        if getattr(cls, '__CLIENT', None) is None:
            cls.__CLIENT = DataClient(base_url=GMI_ComputeEngine_ODPS.api_baseurl, api_key=GMI_ComputeEngine_ODPS.api_key)
        return cls.__CLIENT
