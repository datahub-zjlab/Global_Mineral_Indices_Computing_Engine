...
from GMI_ComputeEngine_ODPS.computing import data_types
from GMI_ComputeEngine_ODPS.computing.client import ComputingClient
import GMI_ComputeEngine_ODPS
...
class Computing():
    ...
    def __client(cls) -> ComputingClient:
        if getattr(cls, '__CLIENT', None) is None:
            cls.__CLIENT = ComputingClient(base_url=GMI_ComputeEngine_ODPS.api_baseurl, api_key=GMI_ComputeEngine_ODPS.api_key)
        return cls.__CLIENT
